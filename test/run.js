...
fs.readdir(dirName, function (err, files) {
    files.forEach(function (filename) {
        ...
        let zhSql = preSql + " VALUES(4, '" + bp.overview.zh + "', '" + bp.symbol + "', 'zh-Hans', '', '" + bp.account + "', '" + bp.email + "', '" + bp.website + "', '" + bp.whitepaper + "', '" + bp.state + "', '" + bp.initial_price.ETH + "', '" + bp.initial_price.USD + "', '" + bp.initial_price.BTC + "', '" + bp.initial_price.MOAC + "', '" + bp.initial_price.SWTC + "', '" + bp.links.blog + "', '" + bp.links.twitter + "', '" + bp.links.telegram + "', '" + bp.links.github + "', '" + bp.links.facebook + "', '" + bp.links.reddit + "', '" + bp.links.slack + "', '" + bp.links.medium + "', '" + bp.published_on + "');";
        let enSql = preSql + " VALUES(4, '" + bp.overview.en + "', '" + bp.symbol + "', 'en', '', '" + bp.account + "', '" + bp.email + "', '" + bp.website + "', '" + bp.whitepaper + "', '" + bp.state + "', '" + bp.initial_price.ETH + "', '" + bp.initial_price.USD + "', '" + bp.initial_price.BTC + "', '" + bp.initial_price.MOAC + "', '" + bp.initial_price.SWTC + "', '" + bp.links.blog + "', '" + bp.links.twitter + "', '" + bp.links.telegram + "', '" + bp.links.github + "', '" + bp.links.facebook + "', '" + bp.links.reddit + "', '" + bp.links.slack + "', '" + bp.links.medium + "', '" + bp.published_on + "');";
        console.log(zhSql);
        console.log(enSql);
    });
});